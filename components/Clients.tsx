...
const content: Record<Lang, {
  ...
  fr: {
    ...
    stats: [
      { n: "10+", l: "grands comptes" },
      { n: "5", l: "secteurs d'activité" },
    ...
    clients: [
      ...
      { name: "Galeries Lafayette", sector: "Retail & Distribution", initial: "GL" },
      { name: "Europe Assistance", sector: "Assurance", initial: "EA" },
      { name: "Ministère de la Justice", sector: "Secteur public", initial: "MJ" },
    ],
  },
  en: {
    ...
    clients: [
      ...
      { name: "Ministère de la Justice", sector: "Public Sector", initial: "MJ" },
    ],
  },
};
